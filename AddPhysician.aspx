<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddPhysician.aspx.cs" Inherits="MedicaidProject.AddPhysician" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server" cssclass="form-horizontal">
        <div class="container">
            <h1 class="text-center">Add Physician</h1>
            <div class="well">
                <div class="row">
                    <div id="Physician" runat="server">
                        <div class="form-group form-inline">
                            ...
                            <asp:TextBox ID="txtNPIKey" CssClass="form-control" runat="server"></asp:TextBox>
                            <br />
                ...
                <div class="row">
                    <div id="Location" runat="server" style="margin-top: 10px">
                        ...
                        <div class="form-inline">
                            ...
                            <asp:TextBox ID="txtPracticeName" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
